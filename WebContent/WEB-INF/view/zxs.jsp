			...
			<table>
				<tr>
					...
					<!--			<td>
							...
							<tr>
								<td>首访时间:</td>
								<td><input class="easyui-datebox" type="text" data-options="editable:false,prompt:'请输入正确时间'" id="s_fistVisitTimezy" name="s_fistVisitTime" /></td>
								<td>是否上门:</td>
								<td>
							...
							<tr>
								<td>上门时间:</td>
								<td><input class="easyui-datebox" type="text"  data-options="editable:false,prompt:'请输入正确时间'" id="s_homeTimezy" name="s_homeTime" /></td>
								<td>定金金额:</td>
								<td><input class="easyui-numberbox" type="text"
